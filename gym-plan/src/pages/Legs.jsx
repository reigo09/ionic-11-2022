      ...
      <IonCardContent>
        <IonList>
          <IonItem>
            ...
            <IonLabel text-wrap>1. BB squat 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
        ...
        <IonInput placeholder="Enter comment"></IonInput>
          ...
          <IonItem>
            ...
            <IonLabel text-wrap>2. Leg extension 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
        ...
        <IonInput placeholder="Enter comment"></IonInput>
          ...
          <IonItem>
            ...
            <IonLabel text-wrap>3. Leg curl 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
        ...
        <IonInput placeholder="Enter comment"></IonInput>
          ...
          <IonItem lines="none">
            ...
            <IonLabel text-wrap>4. Leg press 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
        ...
        <IonInput placeholder="Enter comment"></IonInput>
          ...
          <IonItem lines="none">
            ...
            <IonLabel text-wrap>5. DB calf raise 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
      ...
      <IonCardContent>
        <IonList>
          <IonItem>
            ...
            <IonLabel text-wrap>1. BB front squat 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
        ...
        <IonInput placeholder="Enter comment"></IonInput>
          ...
          <IonItem>
            ...
            <IonLabel text-wrap>2. Romanian deadlift 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
        ...
        <IonInput placeholder="Enter comment"></IonInput>
          ...
          <IonItem lines="none">
            ...
            <IonLabel text-wrap>4. Calf press 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
      ...
      <IonCardContent>
        <IonList>
          <IonItem>
            ...
            <IonLabel text-wrap>1. Hack Squat 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
        ...
        <IonInput placeholder="Enter comment"></IonInput>
          ...
          <IonItem>
            ...
            <IonLabel text-wrap>3. Single-leg RDL 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
        ...
        <IonInput placeholder="Enter comment"></IonInput>
          ...
          <IonItem lines="none">
            ...
            <IonLabel text-wrap>4. Seated calf raise 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
