      ...
      <IonCardContent>
        <IonList>
          <IonItem>
            ...
            <IonLabel text-wrap>1. Close-grip bench press 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
        ...
        <IonInput placeholder="Enter comment"></IonInput>
          ...
          <IonItem>
            ...
            <IonLabel text-wrap>2. Cable one-arm tricep extension 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
        ...
        <IonInput placeholder="Enter comment"></IonInput>
          ...
          <IonItem>
            ...
            <IonLabel text-wrap>3. Dips 4x8<IonCheckbox slot="start"></IonCheckbox><IonItem>
      ...
      <IonCardContent>
        <IonList>
          <IonItem>
            ...
            <IonLabel text-wrap>1. Cable rope pressdown 4x10 <IonCheckbox slot="start"></IonCheckbox><IonItem>
        ...
        <IonInput placeholder="Enter comment"></IonInput>
          ...
          <IonItem>
            ...
            <IonLabel text-wrap>2. Skull crusher 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
        ...
        <IonInput placeholder="Enter comment"></IonInput>
          ...
          <IonItem>
            ...
            <IonLabel text-wrap>3. Overhead triceps extension 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
      ...
      <IonCardContent>
        <IonList>
          <IonItem>
            ...
            <IonLabel text-wrap>1. Incline DB tricep extension 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
        ...
        <IonInput placeholder="Enter comment"></IonInput>
          ...
          <IonItem>
            ...
            <IonLabel text-wrap>2. Standing overhead cable triceps extension 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
        ...
        <IonInput placeholder="Enter comment"></IonInput>
          ...
          <IonItem>
            ...
            <IonLabel text-wrap>3. Cable rear drive 4x8 <IonCheckbox slot="start"></IonCheckbox><IonItem>
